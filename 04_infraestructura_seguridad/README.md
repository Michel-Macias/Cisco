...
```bash
.
├── 📁 teoria/             # 📚 Manual de Infraestructura y FAQ
├── 📁 practica/           # 🛠️ Guías interactivas (Squid, Incident Response)
...
1.  👉 **[LAB 01: Configuración de Proxy Squid](./practica/lab_01_squid_proxy.md)**
    *   Instalación en Linux, control de ACLs y filtrado de contenidos.
2.  👉 **[LAB 02: Análisis de Incidentes (Caso Real)](./practica/lab_02_incident_response.md)**
