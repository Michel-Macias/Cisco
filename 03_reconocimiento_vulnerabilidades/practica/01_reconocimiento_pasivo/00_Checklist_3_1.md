# 📋 Checklist de Seguimiento: Sección 3.1 - Reconocimiento Pasivo

Este documento sirve para trackear el progreso de revisión de los laboratorios y la creación de documentación técnica para la sección 3.1 del Módulo 3.
...
- [x] Crear carpeta `3.1_Reconocimiento_Pasivo/labs/` para los archivos `.md` de cada lab.
...
- Documentación bruta en: `Modulo_3_Reconocimiento_Y_Vulnerabilidades/Docs_Curso_Mod3/`
- Screenshot de objetivos: `Modulo_3_Reconocimiento_Y_Vulnerabilidades/2026-02-23-1771846864_screenshot.png`
